...
/* ===================== 更新列表（静态示例数据） ===================== */
const updates = [
  { date: "2025-11-15", summary: "康斯坦丁尼夫卡：1. 乌克兰国防军从Katerynivka撤退；波克罗夫斯克：1. 澄清了Volodymyrivka以东的前线；2. 澄清了Suvorove附近的前线；3. 澄清了米尔诺格勒以东的前线；4. 俄军在Rih取得了部分成功；扎波罗热：1. 乌克兰国防军从Novovasylivske撤退" },
