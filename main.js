...
/* ===================== 更新列表（静态示例数据） ===================== */
const updates = [
  { date: "2025-02-14", summary: "乌克兰国防军正在扎波罗热/第聂伯彼得罗浮斯克交界处开展 <a href=\"https://CSFS64.github.io/test2/clearing-offensive.html\" target=\"_blank\">清理/进攻行动</a>，我们将优先针对该方向的情况进行更新——目前该地区最新前线已澄清。"},
